...
function handleRequest(request, response){
    ...
    console.re.log("Sum of equation = " +sum);
    console.re.log("Sum : " +sum+"Augend : " +augend+"Addend : " +addend+".");
    // ASSIGNMENT
...
server.listen(server_port, server_ip_address, function(){
    ...
    console.re.log("Server is started and listening for user requests");
    console.re.log("Server ip address is: " +server_ip_address+ ". Server port number is: " +server_port+ ".");
    // ASSIGNMENT
